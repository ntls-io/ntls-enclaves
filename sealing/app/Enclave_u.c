...
sgx_status_t seal_user_data(sgx_enclave_id_t eid, sgx_status_t* retval, const uint8_t* user_id, size_t user_id_length, uint8_t* user_data, size_t sealed_user_data_size, uint8_t* sealed_user_sealing_key)
{
	sgx_status_t status;
	ms_seal_user_data_t ms;
	ms.ms_user_id = user_id;
	ms.ms_user_id_length = user_id_length;
	ms.ms_user_data = user_data;
	ms.ms_sealed_user_data_size = sealed_user_data_size;
	ms.ms_sealed_user_sealing_key = sealed_user_sealing_key;
