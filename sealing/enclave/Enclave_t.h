...
sgx_status_t seal_user_data(const uint8_t* user_id, size_t user_id_length, uint8_t* user_data, size_t sealed_user_data_size, uint8_t* sealed_user_sealing_key);
