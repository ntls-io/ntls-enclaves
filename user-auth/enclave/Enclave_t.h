...
sgx_status_t hash_password(const uint8_t* password, size_t password_length, const uint8_t* salt, const uint8_t* user_id, size_t user_id_length, uint8_t* hash_string);
sgx_status_t verify_password(const uint8_t* password, size_t password_length, const uint8_t* user_id, size_t user_id_length, const uint8_t* stored_hash_string, uint32_t* password_verified);
