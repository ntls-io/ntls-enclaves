...
sgx_status_t row_counter(sgx_enclave_id_t eid, sgx_status_t* retval, const uint8_t* some_string, size_t len, uint64_t* count)
{
	sgx_status_t status;
	ms_row_counter_t ms;
...
sgx_status_t dataset_hashing(sgx_enclave_id_t eid, sgx_status_t* retval, const uint8_t* some_string, size_t len, uint8_t* hash)
{
	sgx_status_t status;
	ms_dataset_hashing_t ms;
	ms.ms_some_string = some_string;
	ms.ms_len = len;
	ms.ms_hash = hash;
...
sgx_status_t dataset_append(sgx_enclave_id_t eid, sgx_status_t* retval, const uint8_t* original_data, size_t original_data_len, const uint8_t* new_data, size_t new_data_len, uint8_t* complete_data, size_t complete_data_len)
{
	...
	ms.ms_original_data = original_data;
	ms.ms_original_data_len = original_data_len;
